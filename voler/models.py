...
class test(models.Model):
    ...
    xxx = models.ForeignKey(Ouser, on_delete=models.CASCADE)
...
class Category(models.Model):
    ...
    description = models.TextField('描述', max_length=240, default=settings.SITE_DESCRIPTION,
                                   help_text='分类描述')
    bigcategory = models.ForeignKey(BigCategory, on_delete=models.CASCADE, verbose_name='大分类')
    ...
    def get_article_list(self):
        return Article.objects.fliter(category=self)
...
class Tag(models.Model):
    ...
    def get_article_list(self):
        return Article.objects.fliter(tags=self)
...
class Article(models.Model):
    ...
    author = models.ForeignKey(Ouser, on_delete=models.CASCADE)
