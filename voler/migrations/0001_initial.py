# Generated by Django 3.0.3 on 2020-06-10 11:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='Voler的个人网站，你好', help_text='用来作为SEO中description,长度参考SEO标准', max_length=240, verbose_name='描述')),
                ('keywords', models.TextField(default='Voler,IT,AI,技术,博客,Python,游戏', help_text='用来作为SEO中keywords,长度参考SEO标准', max_length=240, verbose_name='关键字')),
            ],
            options={
                'verbose_name': '大分类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('xxx', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Category',
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('description', models.TextField(default='Voler的个人网站，你好', help_text='分类描述', max_length=240, verbose_name='描述')),
                ('bigcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='voler.BigCategory', verbose_name='大分类')),
            ],
            options={
                'verbose_name': '分类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='voler.Category', verbose_name='文章分类')),
                ('keywords', models.ManyToManyField(help_text='文章关键词，用来作为SEO中keywords，最好使用长尾词，3-4个足够', to='voler.Keyword', verbose_name='文章关键词')),
                ('tags', models.ManyToManyField(to='voler.Tag', verbose_name='标签')),
            ],
            options={
                'verbose_name': '文章',
